...
function App() {
  ...
  <div className="main-screen">
    <header>
      <img id="profile" src="https://raw.githubusercontent.com/yogirajgutte/yogirajgutte.github.io/352dedfb6779c20e47ec68baa9b61d6e39f0969f/img/logo.png" alt="Logo" width={250} height={200} />
    </header>
    <section className="profile" id="profile">
      <div className="profile-sec-1">
        ...
        <div className="contact">
          <div className>
            ...
            <span>mraoaankitha@gmail.com</span>
          </div>
          <a className="resume-link" href="https://drive.google.com/file/d/1LZh77D4Bi_qYlxJz8QietJ06F7c_P37t/view?usp=drive_link" target="_blank">
      ...
      <div className="profile-sec-2">
        <a className="profile-sec-2-links" href="https://www.linkedin.com/home?originalSubdomain=in" target="_blank">
        ...
        <a className="profile-sec-2-links" href="https://github.com/mraoankitha" target="_blank">
      ...
      <div className="institutes">
        ...
        <div className="inst">
          <div className="inst-name-container-2">
            <p className="inst-name">Sharada PU College</p>
          </div>
          <div className="inst-description">
    ...
    <section className="achievements-section" id="achievements">
      ...
      <div className="achievements-container">
        <a className="achievements-link" href="https://drive.google.com/file/d/1VrTG7eOVc6xAkTbdddL5SkQoBHDNRQtw/view?usp=sharing" target="_blank">
          <div className="achievements-card">
            <img className="achievement-img" src="https://github.com/yogirajgutte/yogirajgutte.github.io/blob/master/img/infytq.jpg?raw=true" alt="INFYTQ" />
            <div className="achievement-desc">
              <div>
                <h4 className="achievement-name">Infosys INFYTQ</h4>
                <p>June 2021</p>
              </div>
        ...
        <a className="achievements-link" href="https://drive.google.com/file/d/1mSf91xXnz2HPd3S0OVMS32N1W4knzuaH/view?usp=sharing" target="_blank">
          <div className="achievements-card">
            <img className="achievement-img" src="https://github.com/yogirajgutte/yogirajgutte.github.io/blob/master/img/hackerearth.jpg" alt="Hackerearth" />
            <div className="achievement-desc">
              <div>
                <h4 className="achievement-name">Hackerearth Machine Learning Challenge</h4>
                <p>January 2021</p>
              </div>
        ...
        <a className="achievements-link" href="https://drive.google.com/file/d/15UKKcTgrD7TISpWnnI8e55dM37fJBXlU/view?usp=sharing" target="_blank">
          <div className="achievements-card">
            <img className="achievement-img" src="" alt="Hackerearth" />
            <div className="achievement-desc">
              <div>
                <h4 className="achievement-name">India's Super Brain ReactJS</h4>
                <p>August 2020</p>
              </div>
              <p>"AIR 10"</p>
            </div>
        ...
        <a className="achievements-link" href="https://www.hackerrank.com/gutteyogiraj" target="_blank">
          <div className="achievements-card">
            <img className="achievement-img" src="" alt="HackerRank" />
            <div className="achievement-desc">
              <div>
                <h4 className="achievement-name">HackerRank Problem Solving</h4>
              </div>
              <p>"5 Star Badge"</p>
            </div>
          </div>
    ...
    <section className="certifications-section" id="certifications">
      ...
      <div className="certifications-container">
        <a className="certifications-link" href="https://insidesherpa.s3.amazonaws.com/completion-certificates/Electronic%20Arts/x4KPrqxMDS4a5isKe_Electronic%20Arts_mkoEH2ZpNYXGJtNi9_completion_certificate.pdf" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="/img/ea-logo.jpg" alt="Electronic Arts" />
        ...
        <a className="certifications-link" href="https://insidesherpa.s3.amazonaws.com/completion-certificates/Accenture%20Nordics/PxenP4rHNE6Bh4nQz_Accenture%20Nordic_mkoEH2ZpNYXGJtNi9_completion_certificate.pdf" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="/img/accenture.jpg" alt="Accenture" />
            <div className="certification-desc">
              <div>
        ...
        <a className="certifications-link" href="https://www.qwiklabs.com/public_profiles/5222ef8f-471c-4a6c-9d36-f70981ec6329" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="/img/gcp.jpg" alt="Google Cloud Platform" />
            <div className="certification-desc">
              <div>
        ...
        <a className="certifications-link" href="https://coursera.org/share/805fefc9213ef8a681755f789fd90e49" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="" alt="Coursera" />
            <div className="certification-desc">
              <div>
        ...
        <a className="certifications-link" href="https://www.hackerrank.com/certificates/5bf928369fba" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="" alt="HackerRank" />
            <div className="certification-desc">
              <div>
        ...
        <a className="certifications-link" href="https://insidesherpa.s3.amazonaws.com/completion-certificates/Deloitte/FqFtWwQzNxJ8Qsh5H_Deloitte_mkoEH2ZpNYXGJtNi9_completion_certificate.pdf" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="" alt="Deloitte" />
            <div className="certification-desc">
              <div>
        ...
        <a className="certifications-link" href="https://portal.certiport.com/Portal/Pages/PrintTranscriptInfo.aspx?action=Cert&id=121&cvid=8nGcnz4m/pNMKbIfAcXkJw==" target="_blank">
          <div className="certifications-card">
            <img className="certification-img" src="https://github.com/yogirajgutte/yogirajgutte.github.io/blob/master/img/microsoft.jpg" alt="Microsoft" />
            <div className="certification-desc">
              <div>
